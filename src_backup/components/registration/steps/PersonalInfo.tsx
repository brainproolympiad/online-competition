...
const PersonalInfo: React.FC<Props> = ({ formData, setFormData, setStepValid }) => {
  ...
  return (
    <div className="bg-white shadow-md rounded-2xl p-6 md:p-10">
      ...
      <div className="text-center mb-10">
        <h2 className="text-2xl md:text-3xl font-bold text-blue-700 flex items-center justify-center gap-3">
          <FaUser className="text-blue-600" /> Personal Information
        </h2>
        <p className="text-gray-600 mt-2">Please fill in all required details carefully.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <label className="text-gray-700 font-medium mb-1 flex items-center">
            <FaCalendar className="mr-2 text-blue-600" /> Date of Birth *
          </label>
          <input
            type="date"
            value={formData.dob || ""}
        ...
        <div>
          <label className="text-gray-700 font-medium mb-1 flex items-center">
            <FaMapMarkerAlt className="mr-2 text-blue-600" /> State of Origin *
          </label>
          <select
            value={selectedState}
            onChange={(e) => {
        ...
        {selectedState && (
          <div>
            <label className="text-gray-700 font-medium mb-1 flex items-center">
              <FaMapMarkerAlt className="mr-2 text-blue-600" /> Local Government Area *
            </label>
            <select
              value={formData.lga || ""}
        ...
        <div className="md:col-span-2">
          <label className="text-gray-700 font-medium mb-1 flex items-center">
            <FaHome className="mr-2 text-blue-600" /> Home Address *
          </label>
          <textarea
      ...
      {/* Footer Note */}
      <div className="bg-blue-50 border border-blue-100 p-4 rounded-lg mt-8 text-sm text-blue-800">
        <p>
          <span className="font-semibold">Note:</span> All fields marked with * are required.
          Your information is confidential and will only be used for registration.
        </p>
      </div>
    </div>
  );
