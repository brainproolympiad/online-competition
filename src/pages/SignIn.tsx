...
const SignIn: React.FC = () => {
        ...
        <div class="text-center">
          ...
          <div class="bg-yellow-900/30 border border-yellow-700/50 rounded-lg p-3 mt-3">
            <p class="text-yellow-200 text-sm">
              Please use your BrainPro Olympiad credentials, or contact support.
            </p>
          </div>
        </div>
      `,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 flex items-center justify-center p-4 md:p-6 relative ">
        ...
        <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 z-50 animate-slideIn">
          <div className="container mx-auto text-center px-4">
            <p className="font-semibold text-sm md:text-base">
              Welcome to BrainPro Olympiad - Elite Academic Excellence Platform
            </p>
            <p className="text-xs opacity-90 mt-1 hidden sm:block">
              Access your personalized dashboard and track your academic journey
            </p>
          </div>
        </div>
      )}
      ...
      {/* Main Login Card */}
      <div className="relative bg-gray-800/90 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-6xl p-2 md:p-2 border border-gray-700/50 animate-fadeIn min-h-[500px] flex flex-col lg:flex-row">
        {/* Left Section - Branding & Features */}
        <div className="flex-1 lg:pr-8 lg:border-r lg:border-gray-700/50 flex flex-col justify-between mb-2 lg:mb-0">
          <div>
            {/* Logo & Title */}
            <div className="flex items-center space-x-3 md:space-x-4 mb-1 md:mb-2">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs md:text-sm">Elite Academic Excellence Platform</p>
              </div>
            </div>
            ...
            <div className="space-y-3 md:space-y-4">
              <h3 className="text-base md:text-lg font-semibold text-white">
                <span className="text-green-400">Platform Features</span>
              </h3>
            ...
            {/* Admin Access Notice */}
            <div className="bg-purple-900/40 border border-purple-700/40 rounded-xl p-3 md:p-4 mt-2 md:mt-2">
              <div className="flex items-center space-x-2">
                <div className="w-6 h-6 md:w-8 md:h-8 bg-purple-500/20 rounded-lg flex items-center justify-center">
                  <span className="text-purple-400 font-bold text-sm">⚡</span>
                </div>
                <div>
                  <p className="text-purple-300 font-semibold text-sm">Participant Access</p>
                  <p className="text-purple-200 text-xs">Use registration credentials for participant dashboard</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Security Badge */}
          <div className="bg-gradient-to-r from-green-900/40 to-emerald-900/40 border border-green-700/40 rounded-xl p-3 md:p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2 md:space-x-3">
                ...
                <div>
                  <p className="text-green-400 font-semibold text-sm md:text-base">Secure Platform</p>
                  <p className="text-green-300 text-xs">Enterprise-grade security</p>
                </div>
              </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mt-3 md:mt-4 space-y-2 sm:space-y-0 text-xs">
            ...
            <button
              onClick={() => Swal.fire({
                ...
                html: "<div class='text-left text-sm'><p class='mb-1'>✓ Stable internet connection</p><p class='mb-1'>✓ Latest browser version</p><p class='mb-1'>✓ JavaScript enabled</p><p>✓ Cookies enabled</p></div>",
                icon: "warning",
                background: '#0a0a0a',
                color: '#fff',
                confirmButtonColor: '#8b5cf6'
        ...
        <div className="flex-1 lg:pl-8 flex flex-col justify-center">
          <div className="mb-1 md:mb-2">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-2">Platform Access</h2>
            <p className="text-gray-400 text-xs md:text-sm">
              Sign in to your BrainPro Olympiad account
            </p>
          </div>

          <form onSubmit={handleSignIn} className="space-y-3 md:space-y-4">
            <div>
              <label className="block text-gray-300 md:mb-1 font-medium text-xs md:text-sm">
                Email Address
              </label>
              <input
                type="email"
          ...
          <div className="mt-4 md:mt-2 pt-3 md:pt-4 border-t border-gray-700/50">
            <p className="text-gray-400 text-xs md:text-sm mb-2 md:mb-1 text-center">Or continue with</p>
